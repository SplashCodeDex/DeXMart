...
test.skip('UPSTREAM PENDING SYNC: src/auto-reply/reply/reply-flow.test.ts', () => {});
...
// 
// describe.skip("[UPSTREAM PENDING SYNC] normalizeInboundTextNewlines", () => {
...
// });
// 
// describe.skip("[UPSTREAM PENDING SYNC] inbound context contract (providers + extensions)", () => {
...
// 
// describe.skip("[UPSTREAM PENDING SYNC] hasLineDirectives", () => {
...
// });
// 
// describe.skip("[UPSTREAM PENDING SYNC] parseLineDirectives", () => {
//   describe.skip("[UPSTREAM PENDING SYNC] quick_replies", () => {
...
//   });
// 
//   describe.skip("[UPSTREAM PENDING SYNC] location", () => {
...
//   });
// 
//   describe.skip("[UPSTREAM PENDING SYNC] confirm", () => {
...
//   });
// 
//   describe.skip("[UPSTREAM PENDING SYNC] buttons", () => {
...
//   });
// 
//   describe.skip("[UPSTREAM PENDING SYNC] media_player", () => {
...
//   });
// 
//   describe.skip("[UPSTREAM PENDING SYNC] event", () => {
...
//   });
// 
//   describe.skip("[UPSTREAM PENDING SYNC] agenda", () => {
...
//   });
// 
//   describe.skip("[UPSTREAM PENDING SYNC] device", () => {
...
//   });
// 
//   describe.skip("[UPSTREAM PENDING SYNC] appletv_remote", () => {
...
//   });
// 
//   describe.skip("[UPSTREAM PENDING SYNC] combined directives", () => {
...
// }
// 
// describe.skip("[UPSTREAM PENDING SYNC] followup queue deduplication", () => {
...
// });
// 
// describe.skip("[UPSTREAM PENDING SYNC] followup queue collect routing", () => {
...
// 
// describe.skip("[UPSTREAM PENDING SYNC] createReplyDispatcher", () => {
...
// });
// 
// describe.skip("[UPSTREAM PENDING SYNC] resolveReplyToMode", () => {
...
// });
// 
// describe.skip("[UPSTREAM PENDING SYNC] createReplyToModeFilter", () => {
