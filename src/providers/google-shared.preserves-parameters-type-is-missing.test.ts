...
test.skip('UPSTREAM PENDING SYNC: src/providers/google-shared.preserves-parameters-type-is-missing.test.ts', () => {});
...
// 
// describe.skip("[UPSTREAM PENDING SYNC] google-shared convertTools", () => {
...
// });
// 
// describe.skip("[UPSTREAM PENDING SYNC] google-shared convertMessages", () => {
