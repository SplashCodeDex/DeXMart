...
test.skip('UPSTREAM PENDING SYNC: src/browser/chrome-extension-options-validation.test.ts', () => {});
...
// 
// describe.skip("[UPSTREAM PENDING SYNC] chrome extension options validation", () => {
