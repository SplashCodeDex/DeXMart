...
test.skip('UPSTREAM PENDING SYNC: src/browser/chrome-extension-background-utils.test.ts', () => {});
...
// 
// describe.skip("[UPSTREAM PENDING SYNC] chrome extension background utils", () => {
