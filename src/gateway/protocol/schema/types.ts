...
export type NodeListNode = SchemaType<"NodeListNode">;
export type NodeListResult = SchemaType<"NodeListResult">;
export type PendingRequest = SchemaType<"PendingRequest">;
export type PairingList = SchemaType<"PairingList">;
export type PairedNode = SchemaType<"PairedNode">;
...
export type ExecApprovalsFile = SchemaType<"ExecApprovalsFile">;
