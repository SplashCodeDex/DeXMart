...
// }
// 
// describe.skip("[UPSTREAM PENDING SYNC] node exec events", () => {
//   beforeEach(() => {
...
// });
// 
// describe.skip("[UPSTREAM PENDING SYNC] voice transcript events", () => {
//   beforeEach(() => {
...
// });
// 
// describe.skip("[UPSTREAM PENDING SYNC] notifications changed events", () => {
//   beforeEach(() => {
//     enqueueSystemEventMock.mockClear();
//     requestHeartbeatNowMock.mockClear();
...
// });
// 
// describe.skip("[UPSTREAM PENDING SYNC] agent request events", () => {
//   beforeEach(() => {
//     agentCommandMock.mockClear();
//     updateSessionStoreMock.mockClear();
//     loadSessionEntryMock.mockClear();
