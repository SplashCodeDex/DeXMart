...
test.skip('UPSTREAM PENDING SYNC: src/infra/outbound/targets.test.ts', () => {});
...
// runResolveOutboundTargetCoreTests();
// 
// describe.skip("[UPSTREAM PENDING SYNC] resolveOutboundTarget defaultTo config fallback", () => {
//   installResolveOutboundTargetPluginRegistryHooks();
// 
...
// });
// 
// describe.skip("[UPSTREAM PENDING SYNC] resolveSessionDeliveryTarget", () => {
...
// });
// 
// describe.skip("[UPSTREAM PENDING SYNC] resolveSessionDeliveryTarget — cross-channel reply guard (#24152)", () => {
