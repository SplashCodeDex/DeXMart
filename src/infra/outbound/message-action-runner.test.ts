...
test.skip('UPSTREAM PENDING SYNC: src/infra/outbound/message-action-runner.test.ts', () => {});
...
// }
// 
// describe.skip("[UPSTREAM PENDING SYNC] runMessageAction context isolation", () => {
//   beforeAll(async () => {
...
// });
// 
// describe.skip("[UPSTREAM PENDING SYNC] runMessageAction sendAttachment hydration", () => {
//   const cfg = {
//     channels: {
//       bluebubbles: {
//         enabled: true,
...
// });
// 
// describe.skip("[UPSTREAM PENDING SYNC] runMessageAction sandboxed media validation", () => {
//   beforeEach(() => {
...
// });
// 
// describe.skip("[UPSTREAM PENDING SYNC] runMessageAction media caption behavior", () => {
//   afterEach(() => {
//     setActivePluginRegistry(createTestRegistry([]));
//   });
// 
...
// });
// 
// describe.skip("[UPSTREAM PENDING SYNC] runMessageAction card-only send behavior", () => {
...
// });
// 
// describe.skip("[UPSTREAM PENDING SYNC] runMessageAction components parsing", () => {
//   const handleAction = vi.fn(async ({ params }: { params: Record<string, unknown> }) =>
//     jsonResult({
//       ok: true,
...
// });
// 
// describe.skip("[UPSTREAM PENDING SYNC] runMessageAction accountId defaults", () => {
