...
test.skip('UPSTREAM PENDING SYNC: src/infra/restart.test.ts', () => {});
...
//   it.skip("[UPSTREAM PENDING SYNC] parses lsof output and filters non-openclaw/current processes", () => {
...
//   });
// 
//   it.skip("[UPSTREAM PENDING SYNC] returns empty when lsof fails", () => {
//     spawnSyncMock.mockReturnValue({
//       error: undefined,
//       status: 1,
//       stdout: "",
...
//   it.skip("[UPSTREAM PENDING SYNC] kills stale gateway pids discovered on the gateway port", () => {
//     spawnSyncMock.mockReturnValue({
//       error: undefined,
//       status: 0,
...
//   });
// 
//   it.skip("[UPSTREAM PENDING SYNC] returns empty when no stale listeners are found", () => {
//     spawnSyncMock.mockReturnValue({
//       error: undefined,
//       status: 0,
//       stdout: "",
