...
describe("[UPSTREAM PENDING SYNC] exec approvals shell parser parity fixture", () => {
...
describe("[UPSTREAM PENDING SYNC] exec approvals wrapper resolution parity fixture", () => {
