...
test.skip('UPSTREAM PENDING SYNC: src/infra/exec-approvals-parity.test.ts', () => {});
...
// 
// describe.skip("[UPSTREAM PENDING SYNC] exec approvals shell parser parity fixture", () => {
...
// });
// 
// describe.skip("[UPSTREAM PENDING SYNC] exec approvals wrapper resolution parity fixture", () => {
