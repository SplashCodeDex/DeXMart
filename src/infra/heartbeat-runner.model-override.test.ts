...
test.skip('UPSTREAM PENDING SYNC: src/infra/heartbeat-runner.model-override.test.ts', () => {});
...
// });
// 
// describe.skip("[UPSTREAM PENDING SYNC] runHeartbeatOnce – heartbeat model override", () => {
