...
test.skip('UPSTREAM PENDING SYNC: src/cron/isolated-agent.auth-profile-propagation.test.ts', () => {});
...
// 
// describe.skip("[UPSTREAM PENDING SYNC] runCronIsolatedAgentTurn auth profile propagation (#20624)", () => {
//   beforeEach(() => {
