...
test.skip('UPSTREAM PENDING SYNC: src/security/audit.test.ts', () => {});
...
// }
// 
// describe.skip("[UPSTREAM PENDING SYNC] security audit", () => {
//   let fixtureRoot = "";
//   let caseId = 0;
...
//   });
// 
//   describe.skip("[UPSTREAM PENDING SYNC] maybeProbeGateway auth selection", () => {
