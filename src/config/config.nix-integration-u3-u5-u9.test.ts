...
test.skip('UPSTREAM PENDING SYNC: src/config/config.nix-integration-u3-u5-u9.test.ts', () => {});
...
// }
// 
// describe.skip("[UPSTREAM PENDING SYNC] Nix integration (U3, U5, U9)", () => {
//   describe.skip("[UPSTREAM PENDING SYNC] U3: isNixMode env var detection", () => {
...
//   });
// 
//   describe.skip("[UPSTREAM PENDING SYNC] U5: CONFIG_PATH and STATE_DIR env var overrides", () => {
...
//   });
// 
//   describe.skip("[UPSTREAM PENDING SYNC] U5b: tilde expansion for config paths", () => {
...
//   });
// 
//   describe.skip("[UPSTREAM PENDING SYNC] U6: gateway port resolution", () => {
...
//   });
// 
//   describe.skip("[UPSTREAM PENDING SYNC] U9: telegram.tokenFile schema validation", () => {
