...
test.skip('UPSTREAM PENDING SYNC: src/commands/channels.surfaces-signal-runtime-errors-channels-status-output.test.ts', () => {});
...
// 
// describe.skip("[UPSTREAM PENDING SYNC] channels command", () => {
//   beforeEach(() => {
