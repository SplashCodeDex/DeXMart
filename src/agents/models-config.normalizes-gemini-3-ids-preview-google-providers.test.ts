...
test.skip('UPSTREAM PENDING SYNC: src/agents/models-config.normalizes-gemini-3-ids-preview-google-providers.test.ts', () => {});
...
// 
// describe.skip("[UPSTREAM PENDING SYNC] models-config", () => {
