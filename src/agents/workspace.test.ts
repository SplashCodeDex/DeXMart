...
test.skip('UPSTREAM PENDING SYNC: src/agents/workspace.test.ts', () => {});
...
// } from "./workspace.js";
// 
// describe.skip("[UPSTREAM PENDING SYNC] resolveDefaultAgentWorkspaceDir", () => {
...
// }
// 
// describe.skip("[UPSTREAM PENDING SYNC] ensureAgentWorkspace", () => {
...
// });
// 
// describe.skip("[UPSTREAM PENDING SYNC] loadWorkspaceBootstrapFiles", () => {
...
// });
// 
// describe.skip("[UPSTREAM PENDING SYNC] filterBootstrapFilesForSession", () => {
