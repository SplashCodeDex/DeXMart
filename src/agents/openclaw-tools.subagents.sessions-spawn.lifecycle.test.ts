...
test.skip('UPSTREAM PENDING SYNC: src/agents/openclaw-tools.subagents.sessions-spawn.lifecycle.test.ts', () => {});
...
// }
// 
// describe.skip("[UPSTREAM PENDING SYNC] openclaw-tools: subagents (sessions_spawn lifecycle)", () => {
//   beforeEach(() => {
//     resetSessionsSpawnConfigOverride();
//     setSessionsSpawnConfigOverride({
//       session: {
