...
test.skip('UPSTREAM PENDING SYNC: src/agents/models-config.preserves-explicit-reasoning-override.test.ts', () => {});
...
// };
// 
// describe.skip("[UPSTREAM PENDING SYNC] models-config: explicit reasoning override", () => {
