...
export class CampaignController {
  ...
  static async listCampaigns(req: Request, res: Response) {
    ...
    if (result.success) {
      ...
      res
        .status(500)
        .json({ success: false, error: result.error?.message || "Failed to fetch campaigns" });
    }
  }
  ...
  static async createCampaign(req: Request, res: Response) {
    ...
    if (result.success) {
      ...
      res
        .status(400)
        .json({ success: false, error: result.error?.message || "Failed to create campaign" });
    }
  }
  ...
  static async startCampaign(req: Request, res: Response) {
    ...
    if (result.success) {
      ...
      res
        .status(400)
        .json({ success: false, error: result.error?.message || "Failed to start campaign" });
    }
  }
  ...
  static async pauseCampaign(req: Request, res: Response) {
    ...
    if (result.success) {
      ...
      res
        .status(400)
        .json({ success: false, error: result.error?.message || "Failed to pause campaign" });
    }
  }
  ...
  static async resumeCampaign(req: Request, res: Response) {
    ...
    if (result.success) {
      ...
      res
        .status(400)
        .json({ success: false, error: result.error?.message || "Failed to resume campaign" });
    }
  }
  ...
  static async duplicateCampaign(req: Request, res: Response) {
    ...
    if (result.success) {
      ...
      res
        .status(500)
        .json({ success: false, error: result.error?.message || "Failed to duplicate campaign" });
    }
  }
  ...
  static async deleteCampaign(req: Request, res: Response) {
    ...
    if (result.success) {
      ...
      res
        .status(500)
        .json({ success: false, error: result.error?.message || "Failed to delete campaign" });
    }
  }
}
