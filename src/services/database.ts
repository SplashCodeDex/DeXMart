...
export class DatabaseService {
  ...
  async updateUser(
    ...
    try {
      ...
      await firebaseService.setDoc<"users/{userId}/members">(
        "members",
        jid,
        updatePayload,
        tenantId,
  ...
  async updateGroup(
    tenantId: string,
    jid: string,
    data: Partial<ChannelGroupDocument>,
  ): Promise<Result<void>> {
    try {
      const updatePayload = {
        ...data,
      ...
      await firebaseService.setDoc<"users/{userId}/groups">(
        "groups",
        jid,
        updatePayload,
        tenantId,
  ...
  public user = {
    ...
    update: (jid: string, data: Partial<ChannelMember>, tenantId: string = "system") =>
      this.updateUser(tenantId, jid, data),
  ...
  public group = {
    ...
    update: (jid: string, data: Partial<ChannelGroupDocument>, tenantId: string = "system") =>
      this.updateGroup(tenantId, jid, data),
  };
  ...
  async getDoc<T>(
    ...
    return (await firebaseService.getDoc(
      collection as "members" | "groups",
      docId,
      tenantId,
    )) as T | null;
  }
  ...
  async delete(key: string): Promise<void> {
    ...
    await firebaseService.setDoc(
      "system" as "members" | "groups",
      key,
      deletedDoc as unknown as Record<string, unknown>,
      undefined,
      true,
    );
  }
