...
describe("[UPSTREAM PENDING SYNC] AgentService", () => {
  ...
  describe("[UPSTREAM PENDING SYNC] ensureSystemAgent", () => {
  ...
  describe("[UPSTREAM PENDING SYNC] createAgent", () => {
    it("should create an agent when authority allows", async () => {
      ...
      const result = await service.createAgent(
        tenantId,
        { name: "My Bot", personality: "Helpful" },
        userId,
      );
  ...
  describe("[UPSTREAM PENDING SYNC] deleteAgent", () => {
    it("should delete agent and shutdown all child channels", async () => {
      ...
      vi.mocked(channelService.getChannelsForAgent).mockResolvedValue({
        success: true,
