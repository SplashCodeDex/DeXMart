...
test.skip("UPSTREAM PENDING SYNC: src/services/contactService.test.ts", () => {});
...
//
//
// describe.skip('[UPSTREAM PENDING SYNC] ContactService', () => {
...
//   });
//
//   describe.skip('[UPSTREAM PENDING SYNC] importContacts', () => {
