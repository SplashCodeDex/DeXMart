...
test.skip('UPSTREAM PENDING SYNC: src/signal/monitor/event-handler.mention-gating.test.ts', () => {});
...
// }
// 
// describe.skip("[UPSTREAM PENDING SYNC] signal mention gating", () => {
...
// });
// 
// describe.skip("[UPSTREAM PENDING SYNC] renderSignalMentions", () => {
//   const PLACEHOLDER = "\uFFFC";
// 
