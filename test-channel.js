...
async function testChannelAPI() {
    ...
    const token = jwt.sign({ tenantId: 'system_default', id: 'admin_user', role: 'system_admin' }, secret, { expiresIn: '1h' });
    ...
    const connectRes = await fetch(`http://localhost:3001/api/internal/channels/${channel.id}/connect`, {
        method: 'POST',
